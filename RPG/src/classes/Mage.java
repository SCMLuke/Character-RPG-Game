...
public class Mage extends Player {
    public Mage(int health, int attackPower, int defensePower, int magicPower, String name) {
        super(health, attackPower, defensePower, magicPower, name);
        super.setClassPicture(new ImageIcon(this.getClass().getResource("/images/mage.png")));
    }
