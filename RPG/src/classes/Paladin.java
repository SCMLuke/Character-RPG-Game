...
public class Paladin extends Player {
    public Paladin(int health, int attackPower, int defensePower, int magicPower, String name) {
        super(health, attackPower, defensePower, magicPower, name);
        super.setClassPicture(new ImageIcon(this.getClass().getResource("/images/paladin.png")));
    }
